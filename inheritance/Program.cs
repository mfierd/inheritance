...
namespace LatihanInheritance
{
    class Program
    {
        ...
        {
            Person person = new Person("Dion", 19);
            person.GetNameAndAge();

            Teacher teacher = new Teacher("Bambang", 38, "190320", "Computer Programming");
            teacher.GetNameAndAge();

            Student student = new Student("Dion Ferdian", 19, "19.11.2789", "muhammad.2789@students.amikom.ac.id");
